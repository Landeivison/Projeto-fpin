                                        ...
                                        <tbody>
                                          <?php foreach ($rows as  $value){ ?>                  
                                            <tr>
                                                ...
                                                <td><img src="img/editar.png">Editar</a></td>
                                                <td><img src="img/deletar.png">Excluir</a><?php }?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <div class="alert-success alert-autocloseable-success">
                              <?php 
                                       $msn = isset($_SESSION["msn"]) ? $_SESSION["msn"] : "" ;
                       echo $msn;
                     unset ($_SESSION["msn"]);?> </div>
                                </div>         
              </form>
          <!-- END FORM-->
